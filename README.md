...
AI 기반 사진 분석 및 관리 플랫폼으로, 사용자가 업로드한 사진을 AI가 분석하여 상세한 피드백을 제공합니다. 사진 관리, 분석 결과 확인, 공개/비공개 설정 등의 기능을 제공합니다.

## 주요 기능

1. **사진 업로드 및 분석**
   - 사용자가 사진을 업로드하면 AI가 자동으로 분석
...
- **Google Gemini API**: 대체 이미지 분석 엔진
...
2. **비용 관리**: AI API 호출 최적화를 통한 비용 효율성 (중복 분석 방지)
3. **사용자 경험**: 빠른 응답 시간과 직관적인 UI를 통한 부드러운 사용자 경험 제공
4. **캐싱 전략**: 빈번하게 조회되는 데이터에 대한 효율적인 캐싱 구현
